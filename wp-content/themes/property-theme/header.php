		...
		<div class="top-header">
			<div class="container">
				<div class="col-md-4 col-sm-4">
					...
					<div class="info">
						Tongkol Raya No.5 - Minormartani</br>
						Sleman, Yogyakarta
					</div>
				</div>
				<div class="col-md-4 col-sm-4">
				...
				<div class="col-md-4 col-sm-4">
					...
					<div class="info">
						<a href="tel:+62123456786">(+62) 123 456 7896</br></a>
			...
			<div class="container">
				<nav class="navbar">
				    <div class="navbar-header">
				      ...
				      <a class="navbar-brand" href="#"><img src="assets/images/logo-back-white.jpg"></a>
				    </div>
